...
class TestDefsUses(unittest.TestCase):
    ...
    def test_exceptions(self):
        ...
        self.assertEqual(len(analyseDefsUses.statsDefs), 14)
        self.assertEqual(analyseDefsUses.statsDefs[0]["line"], "21")
        self.assertEqual(analyseDefsUses.statsDefs[0]["info"], "a")
        self.assertEqual(analyseDefsUses.statsDefs[1]["line"], "22")
        self.assertEqual(analyseDefsUses.statsDefs[1]["info"], "a")
        self.assertEqual(analyseDefsUses.statsDefs[2]["line"], "23")
        self.assertEqual(analyseDefsUses.statsDefs[2]["info"], "j")
        self.assertEqual(analyseDefsUses.statsDefs[3]["line"], "24")
        self.assertEqual(analyseDefsUses.statsDefs[3]["info"], "a")
        self.assertEqual(analyseDefsUses.statsDefs[4]["line"], "25")
        self.assertEqual(analyseDefsUses.statsDefs[4]["info"], "i")
        self.assertEqual(analyseDefsUses.statsDefs[5]["line"], "28")
        self.assertEqual(analyseDefsUses.statsDefs[5]["info"], "i")
        self.assertEqual(analyseDefsUses.statsDefs[6]["line"], "31")
        self.assertEqual(analyseDefsUses.statsDefs[6]["info"], "j")
        self.assertEqual(analyseDefsUses.statsDefs[7]["line"], "34")
        self.assertEqual(analyseDefsUses.statsDefs[7]["info"], "a")
        self.assertEqual(analyseDefsUses.statsDefs[8]["line"], "35")
        self.assertEqual(analyseDefsUses.statsDefs[8]["info"], "j")
        self.assertEqual(analyseDefsUses.statsDefs[9]["line"], "38")
        self.assertEqual(analyseDefsUses.statsDefs[9]["info"], "data")
        self.assertEqual(analyseDefsUses.statsDefs[10]["line"], "40")
        self.assertEqual(analyseDefsUses.statsDefs[10]["info"], "balances")
        self.assertEqual(analyseDefsUses.statsDefs[11]["line"], "40")
        self.assertEqual(analyseDefsUses.statsDefs[11]["info"], "msg")
        self.assertEqual(analyseDefsUses.statsDefs[12]["line"], "41")
        self.assertEqual(analyseDefsUses.statsDefs[12]["info"], "balances")
        self.assertEqual(analyseDefsUses.statsDefs[13]["line"], "41")
        self.assertEqual(analyseDefsUses.statsDefs[13]["info"], "i")
