...
class TestDoSWithBlockGasLimit(unittest.TestCase):

    testFile = "DoSWithBlockGasLimit"
    ...
    def test_selfDestruct(self):
        ...
        self.assertEqual(len(analyseDoSPatterns.statsDoSWithBlockGasLimit), 1)
        self.assertEqual(analyseDoSPatterns.statsDoSWithBlockGasLimit[0]["line"], "14")
        self.assertEqual(analyseDoSPatterns.statsDoSWithBlockGasLimit[0]["info"], "send")
        astFD.close()
